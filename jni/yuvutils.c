...
Java_cn_hashdog_yuvlibrary_YuvUtils_argbtoi420(JNIEnv *env, jclass type, jbyteArray src_argb_,
...
JNIEXPORT void JNICALL
Java_cn_hashdog_yuvlibrary_YuvUtils_convertToI420(JNIEnv *env, jclass type, jbyteArray src_frame_,
...
JNIEXPORT void JNICALL
Java_cn_hashdog_yuvlibrary_YuvUtils_convertToArgb(JNIEnv *env, jclass type, jbyteArray src_frame_,
...
JNIEXPORT void JNICALL
Java_cn_hashdog_yuvlibrary_YuvUtils_yuvI420ToNV21(JNIEnv *env, jclass type, jbyteArray i420Src_,
    ...
    I420ToNV21(
            (const uint *) src_i420_y_data, width,
            (const uint *) src_i420_u_data, width >> 1,
            (const uint *) src_i420_v_data, width >> 1,
            (uint *) src_nv21_y_data, width,
            (uint *) src_nv21_vu_data, width,
            width, height);
